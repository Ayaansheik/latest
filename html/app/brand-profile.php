...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['profile_photo'])) {
    ...
    if (move_uploaded_file($profile_photo['tmp_name'], $upload_file)) {
        ...
        $photo_url = basename($profile_photo['name']);

        try {
            // Insert photo information into the database
            $insert_query = "INSERT INTO `images` (brand_id, profile_id, photo_url) VALUES (:brand_id, :profile_id, :photo_url)";
            $insert_prepare = $connection->prepare($insert_query);
            $insert_prepare->bindParam(":brand_id", $user_id);
            $insert_prepare->bindParam(":profile_id", $user_id);
            $insert_prepare->bindParam(":photo_url", $photo_url);
    ...
    .upload-btn:hover {
        ...
        <div class="header-for-bg">
            <div class="background-header position-relative">
                <img src="../app/uploads/<?php echo htmlspecialchars($brandProfile['logo_img']); ?>" alt="Profile Image"class="img-fluid w-100" alt="header-bg" >
                ...
                <div class="col-lg-12">
                    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                        <div class="group-info d-flex align-items-center">
                            <div class="me-3">
                                <img class="rounded-circle img-fluid avatar-100" src="../app/uploads/<?php echo htmlspecialchars($brandProfile['bg_img']); ?>" alt="Profile Image">
                            </div>
                            <div class="info">
        ...
        <div class="card-header d-flex justify-content-between">
            ...
            <form method="post" action="brand-profile.php" enctype="multipart/form-data">
                ...
                <input type="file" id="file-upload" name="profile_photo" style="display: none;" accept="image/*" />
                <button type="submit" style="display: none;" id="upload-submit">Upload</button>
            </form>
        </div>
    </div>
                    <div class="card">
