...
header('location:reset-password.php');
     ...
     echo "<script>alert('kindly enter correct otp')</script>";
 }
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                        <div class="sign-in-from">
                            <h1 class="mb-0">Confirm Resetting Password</h1>
                            ...
                            <form class="mt-4">
                                ...
                                <div class="d-inline-block w-100">
                                   <button type="submit" class="btn btn-primary float-right" name="submit">Confirm</button>
                                </div>
                            </form>
                        </div>
                    </div>
